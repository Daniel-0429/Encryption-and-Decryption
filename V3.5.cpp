    ...
    while(1){
        ...
        if(s=="E"){
            if(swi=="C"){
                ...
                for(int i=0;i<pwd.size();++i){
                    if(pwd[i]>='A'&&pwd[i]<='Z'){
                        pwd[i]=((pwd[i]%' ')+key%10+pk[static_cast<int>(i%(pk.size()-1))]-'0')%26+'A';
                ...
                for(int i=0;i<pwd.size();++i){
                    ...
                    if(pwd[i]>='A'&&pwd[i]<='Z'){
                        pwd[i]=((pwd[i]%' ')+i+key*2+pk[static_cast<int>(i%(pk.size()-1))]-'0')%26+'A';
                    }else if(pwd[i]>='a'&&pwd[i]<='z'){
                        pwd[i]=((pwd[i]%' ')+i+key*2+pk[static_cast<int>(i%(pk.size()-1))]-'0')%26+'a';
            ...
            if(swi=="C"){
                ...
                for(int i=0;i<pwd.size();++i){
                    if(pwd[i]>='A'&&pwd[i]<='Z'){
                        pwd[i]=((pwd[i]%' ')+24-key%10+26-pk[static_cast<int>(i%(pk.size()-1))]+'0')%26+'A';
                    }else if(pwd[i]>='a'&&pwd[i]<='z'){
                        pwd[i]=((pwd[i]%' ')+24-key%10+26-pk[static_cast<int>(i%(pk.size()-1))]+'0')%26+'a';
                    }else if(pwd[i]>0&&pwd[i]<128){
                        pwd[i]+=key%10;
                ...
                for(int i=0;i<pwd.size();++i){
                    if(pwd[i]>='A'&&pwd[i]<='Z'){
                        pwd[i]=((pwd[i]%' ')+(26-i-2-(keya[i]-'0')*2)+26-pk[static_cast<int>(i%(pk.size()-1))]+'0')%26+'A';
                    }else if(pwd[i]>='a'&&pwd[i]<='z'){
                        pwd[i]=((pwd[i]%' ')+(26-i-2-(keya[i]-'0')*2)+26-pk[static_cast<int>(i%(pk.size()-1))]+'0')%26+'a';
                    }else if(pwd[i]>='0'&&pwd[i]<='9'){
                        pwd[i]-=(keya[i]-'0');
