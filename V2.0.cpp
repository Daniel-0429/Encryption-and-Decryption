...
int main(){
    std::srand(time(0));
    cout<<"Passwd_Tools 2.0.0.1"<<endl;
    ...
    while(1){
        ...
        if(s=="E"){
            ...
            if(swi=="C"){
                ...
                for(int i=0;i<pwd.size();++i){
                    if(pwd[i]>='A'&&pwd[i]<='Z'){
                        pwd[i]=((pwd[i]%' ')+(26-i-2-(keya[i]-'0')*2))%26+'A';
                    }else if(pwd[i]>='a'&&pwd[i]<='z'){
                        pwd[i]=((pwd[i]%' ')+(26-i-2-(keya[i]-'0')*2))%26+'a';
                    }else if(pwd[i]>='0'&&pwd[i]<='9'){
                        pwd[i]-=(keya[i]-'0');
